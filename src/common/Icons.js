...
export const IconHome: SpecificIconType = makeIcon(IoniconsIcon, 'home-outline');
export const IconPersonCircle: SpecificIconType = makeIcon(IoniconsIcon, 'person-circle-outline');
export const IconChatBubbles: SpecificIconType = makeIcon(IoniconsIcon, 'chatbubbles-outline');
export const IconChatBubble: SpecificIconType = makeIcon(IoniconsIcon, 'chatbubble-outline');
export const IconChatBubbleEllipses: SpecificIconType = makeIcon(IoniconsIcon, 'chatbubble-ellipses-outline');
